...
Перетаскиваем файлы с вашего ПК на Raspberry Pi по пути ~/home/pi/printer_data/config (актуально на август 2023, разработчики клиппер любят менять пути). В итоге в этой папке у вас должен быть набор конфигурационных файлов:
